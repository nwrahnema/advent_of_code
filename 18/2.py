...
def combine_snailfishes(snailfish1: Snailfish, snailfish2: Snailfish) -> Snailfish:
    snailfish1 = deepcopy(snailfish1)
    snailfish2 = deepcopy(snailfish2)
...
def main():
    with open("input.txt") as file:
        ...
        print(
            max(
                get_magnitude(combine_snailfishes(snailfish1, snailfish2))
                for snailfish1, snailfish2 in permutations(snailfishes, r=2)
            )
        )
